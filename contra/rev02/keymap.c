...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LY0] = {
		...
		{KC_LCTL, KC_LALT, KC_LGUI, KC_BSLS, MO(1), KC_SPC, MO(2), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT},
	},
	...
	[_LY2] = {
		...
		{KC_TRNS, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NUHS, KC_NUBS, KC_MUTE, KC_VOLD, KC_VOLU}, 
